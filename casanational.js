...
//----------------VT--------------------//
  ...
  // إنشاء الأزرار
  const CasaSNormalButton = createButton("Casa student Normal", function() {
(function () {
    "use strict";
            ...
            if (VisaSubTypeElement !== null) {
                ...
                if (isVisibleSubVisa && isOkButtonClicked) {
                    ...
                    var VisaSubType = $("#VisaSubType" + i).data("kendoDropDownList");
                     VisaSubType.select(1); // 1 corresponds to 'STUDENT'
...
document.addEventListener('DOMContentLoaded', function() {
  ...
  content
    ...
    console.log("تم تنفيذ الشيفرة لزر Casa Student Normal بنجاح!");
  });
const CasaSPremiumButton = createButton("Casa Student Premium", function() {
(function () {
    "use strict";
  (async function() {
    'use strict';
        ...
        for (var i = 1; i < 10; i++) {
            ...
            if (VisaSubTypeElement !== null) {
                ...
                if (isVisibleSubVisa && isOkButtonClicked) {
                    console.log("VisaSubType " + i + " is visible");
                    var VisaSubType = $("#VisaSubType" + i).data("kendoDropDownList");
                     VisaSubType.select(1); // 1 corresponds to 'CasaNational'
                    VisaSubType.trigger("change");
    ...
    console.log("تم تنفيذ الشيفرة لزر Casa Student بنجاح!");
  });
    
  const CasaRNormalButton = createButton("Casa Reunification  Normal", function() {
(function () {
    "use strict";
...
if (targetSibling) {
 ...
 const row1 = document.createElement('div');
  ...
  row1.appendChild(CasaSNormalButton);
  row1.appendChild(CasaRNormalButton);
  row1.appendChild(CasaWNormalButton);
    
  const row2 = document.createElement('div');
  row2.style.display = 'flex';
  row2.appendChild(CasaSPremiumButton);
  row2.appendChild(CasaRPremiumButton);
